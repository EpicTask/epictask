  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <CustomText variant="bold" style={styles.headerTitle}>{kidName}'s Progress</CustomText>
      </View>
        ...
        {progress ? (
          <>
              ...
              <View style={styles.card}>
                <View style={styles.storyHeader}>
                  ...
                  <View style={styles.storyInfo}>
                    <CustomText variant="bold" style={styles.storyTitle}>{progress.story_title || "The Broken Toy"}</CustomText>
                    <CustomText style={styles.storyDetail}>Started: {new Date(progress.last_activity_at || Date.now()).toLocaleDateString()}</CustomText>
                  </View>
                </View>
                ...
                <View style={styles.progressContainer}>
                  <View style={styles.progressHeader}>
                    ...
                    <CustomText>{Math.round((progress.current_story_progress || 0) * 100)}%</CustomText>
                  </View>
                  <View style={styles.progressBarBg}>
                    <View style={[styles.progressBarFill, { width: `${(progress.current_story_progress || 0) * 100}%` }]} />
                  </View>
                </View>
              </View>
            </View>
            ...
            <View style={styles.section}>
              ...
              <View style={styles.statsGrid}>
                <View style={styles.statCard}>
                  ...
                  <CustomText variant="bold" style={styles.statValue}>{progress.total_xp_earned}</CustomText>
                </View>
                <View style={styles.statCard}>
                  <CustomText style={styles.statLabel}>Rewards</CustomText>
                  <CustomText variant="bold" style={styles.statValue}>{progress.total_payout_amount} eTask</CustomText>
                </View>
              </View>
            </View>
            ...
            <View style={styles.section}>
              ...
              <TouchableOpacity style={styles.dangerButton} onPress={handleResetStory}>
          ...
          <View style={styles.emptyState}>
            <MaterialCommunityIcons name="emoticon-neutral-outline" size={64} color={COLORS.grey} />
            <CustomText style={styles.emptyText}>No narrative progress yet.</CustomText>
          </View>
        )}
      </ScrollView>
    </SafeAreaView>
