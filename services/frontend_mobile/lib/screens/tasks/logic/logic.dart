...
Future<String> getUserDisplayName(String? uid) async {
  ...
  completeTask(
    ...
    final TaskCompleted event = TaskCompleted(completed_by_id: task.assigned_to_ids?.first ?? '',task_id: task.task_id, marked_completed: task.marked_completed == null ? true : !task.marked_completed!
);
