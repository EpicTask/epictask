...
from ...domain.narrative_models import AdvanceRequest, AdvanceResponse, StoryProgress, RecommendRequest, NarrativeUserProfile as UserProfile
from ...domain.narrative_validators import (
    validate_age,
...
from ...storage.narrative_firestore import firestore_service
from ...services.narrative.recommender_client import recommender_client
